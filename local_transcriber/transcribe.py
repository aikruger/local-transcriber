...
Outputs JSON objects to stdout.
"""
...
def main():
    ...
    try:
        ...
        # Using faster_whisper to enable generator output for progress
    ...
    # Note: Diarization is explicitly excluded here since we orchestrated it
    # outside of whisper in file-transcriber.ts using PyannoteWorker.

    # Emit meta first for backwards compat
    print(json.dumps({
        "type": "meta",
